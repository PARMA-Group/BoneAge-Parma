...
import math
import os
from KalininRegressionModel import KalininRegression
...
class VGG(nn.Module):
# Voy a ponerle 1 pirqye es una regresión
...
def kalinin(state_dict):
    model = None
    init = False if not os.path.isfile(state_dict) else True
    model = KalininRegression(init)
